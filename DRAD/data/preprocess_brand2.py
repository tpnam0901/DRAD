...
column = torch.load("battery_data/battery_brand2/column.pkl")
train_label = pd.read_csv("battery_data/battery_brand2/label/train_label.csv")
test_label = pd.read_csv("battery_data/battery_brand2/label/test_label.csv")
all_label = pd.concat([train_label, test_label], ignore_index=True)

data_files = glob.glob("battery_data/battery_brand2/test/*.pkl") + glob.glob("battery_data/battery_brand2/train/*.pkl")
...
out_dir = "battery_data/battery_brand2/data_by_segments/"
...
with open("battery_data/battery_brand2/fold_0_train.txt", "w") as train_file, open(
    "battery_data/battery_brand2/fold_0_val.txt", "w"
) as test_file, open("battery_data/battery_brand2/fold_label.csv", "w") as csv_file:
