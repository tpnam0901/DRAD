...
for fold in range(num_folds):
    ...
    with open(f"battery_data/battery_brand2/fold_{fold}_train.txt", "w") as train_file, open(
        f"battery_data/battery_brand2/fold_{fold}_test.txt", "w"
    ) as test_file:
