...
column = torch.load("battery_data/battery_brand1/column.pkl")
train_label = pd.read_csv("battery_data/battery_brand1/label/train_label.csv")
test_label = pd.read_csv("battery_data/battery_brand1/label/test_label.csv")
all_label = pd.concat([train_label, test_label], ignore_index=True)

data_files = glob.glob("battery_data/battery_brand1/test/*.pkl") + glob.glob("battery_data/battery_brand1/train/*.pkl")
...
out_dir = "battery_data/battery_brand1/data_by_segments/"
