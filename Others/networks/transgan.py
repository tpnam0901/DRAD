...
class TransGAN(nn.Module):
    def __init__(self, cfg: Config):
        ...
        self.projection = nn.Linear(7, cfg.transgan_input_embedding_dimension)
        ...
        self.linear = nn.Linear(cfg.transgan_hidden_layers, 5)
    ...
    def forward(self, inputs):
        ...
        projection = self.projection(inputs["normed_time_series"])
...
class Discriminator(TransGAN):
    def __init__(self, cfg: Config):
        ...
        self.projection = nn.Linear(5, cfg.transgan_input_embedding_dimension)
